...
import com.lingkarinovasimuda.githubuserapp.activity.MainActivity;
...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    public void setRepeatingAlarm(Context context, String type, String time, String message) {
        ...
        Log.d("TESTING", "setRepeatingAlarm: "+timeArray[0]+" "+timeArray[1]);
    ...
    public void cancelAlarm(Context context, String type) {
        ...
        Toast.makeText(context, "Repeating alarm removed", Toast.LENGTH_SHORT).show();
    }
}